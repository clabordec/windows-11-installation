<h1>Installing and setting up Windows 11 Pro</h1>

This project outlines the installation and set up of Windows 11 Pro.<br />
...
- Install and set up Windows 11 Pro
- Bypass the network requirments
- Create the following user: `Student`
- Login as `Student`
